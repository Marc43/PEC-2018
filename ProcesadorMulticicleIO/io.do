...
add wave -noupdate -divider {SeÃÂÃÂ±ales de la mem fisica}
...
add wave -noupdate -radix hexadecimal -childformat {{/test_sisa/SoC/controladores_IO0/ports(7) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(6) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(5) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(4) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(3) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(2) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(1) -radix hexadecimal} {/test_sisa/SoC/controladores_IO0/ports(0) -radix hexadecimal}} -expand -subitemconfig {/test_sisa/SoC/controladores_IO0/ports(7) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(6) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(5) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(4) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(3) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(2) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(1) {-radix hexadecimal} /test_sisa/SoC/controladores_IO0/ports(0) {-radix hexadecimal}} /test_sisa/SoC/controladores_IO0/ports
add wave -noupdate -divider {UC & DATA PATH (E/S)}
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/unidad_control0/addr_a
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/unidad_control0/wr_port
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/unidad_control0/rd_port
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/datapath0/immed
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/datapath0/rd_io
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/datapath0/wr_io
add wave -noupdate -radix hexadecimal /test_sisa/SoC/proc0/datapath0/addr_port
...
update
WaveRestoreZoom {0 ps} {7362432 ps}
