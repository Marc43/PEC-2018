...
add wave -noupdate -group {system
...
add wave -noupdate -group {gpurpose
...
add wave -noupdate -group {ctrl_IO_intr_inta
...
add wave -noupdate -group {input_ctrl_intr_inta
...
WaveRestoreCursors {{Cursor 1} {2246771 ps} 0}
...
update
WaveRestoreZoom {3475703 ps} {4064717 ps}
